...
- **Gastos (`/api/expenses`)**: registro de gastos con concepto, categoría de gasto, monto, proveedor opcional, medio de pago, soporte documental y vinculación con el turno de caja vigente. Después de la creación, el valor, la fecha de negocio y el indicador de salida de caja son inmutables; la actualización solo admite nombre, descripción, medio de pago y proveedor.
