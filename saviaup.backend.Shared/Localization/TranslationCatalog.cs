        ...
        new ReadOnlyDictionary<string, IReadOnlyDictionary<string, string>>(
            new Dictionary<string, IReadOnlyDictionary<string, string>>(StringComparer.OrdinalIgnoreCase)
            {
                ["es"] = new ReadOnlyDictionary<string, string>(new Dictionary<string, string>
                {
                    ...
                    [LocalizationKeys.NavigationSectionName("expenses")] = "Gastos",
                    ...
                    [LocalizationKeys.ModuleName("reports")] = "Estadísticas",
                    [LocalizationKeys.ModuleName("statistics")] = "Estadísticas",
                    [LocalizationKeys.ModuleName("billing")] = "Facturación",
                    [LocalizationKeys.ModuleName("expenses")] = "Gastos",
                    [LocalizationKeys.ModuleName("suppliers")] = "Proveedores",
                    [LocalizationKeys.ModuleName("settings")] = "Configuración",
                    [LocalizationKeys.ModuleName("cash_registers")] = "Cajas",
                    [LocalizationKeys.ModuleName("digital_menu")] = "Menú digital",
                    [LocalizationKeys.ModuleName("printing")] = "Impresión",
                    [LocalizationKeys.NavigationOptionName("tables.manage")] = "Administrar mesas",
                    [LocalizationKeys.NavigationOptionName("cash-registers.manage")] = "Administrar cajas",
                    [LocalizationKeys.NavigationOptionName("digital-menu.manage")] = "Administrar menú",
                    ...
                    [LocalizationKeys.ProductInUse] = "El producto hace parte de un combo. Retíralo del combo antes de desactivarlo, convertirlo o eliminarlo.",
                    ...
                    [LocalizationKeys.CashRegisterNotFound] = "No encontramos la caja solicitada.",
                    [LocalizationKeys.CashRegisterNameAlreadyExists] = "Ya existe una caja con ese nombre en la organización.",
                    [LocalizationKeys.CashRegisterSingleActiveExceeded] = "Ya existe una caja activa en esta organización. Desactívela antes de activar otra.",
                    [LocalizationKeys.CashRegisterInUse] = "La caja tiene operaciones registradas y no puede eliminarse.",
                    [LocalizationKeys.PrintingLocationNotFound] = "No encontramos la sede de impresión solicitada.",
                    [LocalizationKeys.PrintAgentNotFound] = "No encontramos el agente de impresión solicitado.",
                    [LocalizationKeys.PrintAgentPairingInvalid] = "El código de vinculación no es válido o expiró.",
                    [LocalizationKeys.PrintAgentCredentialInvalid] = "La credencial del agente no es válida.",
                    [LocalizationKeys.PrinterNotFound] = "No encontramos la impresora solicitada.",
                    [LocalizationKeys.PrintingZoneNotFound] = "No encontramos la zona de impresión solicitada.",
                    [LocalizationKeys.PrintingZoneAlreadyExists] = "Ya existe una zona de impresión con ese nombre en la sede.",
                    [LocalizationKeys.PrintJobNotFound] = "No encontramos el trabajo de impresión solicitado.",
                    [LocalizationKeys.PrintJobInvalidStatus] = "El trabajo de impresión no se encuentra en un estado válido para esta acción.",
                ...
                ["en"] = new ReadOnlyDictionary<string, string>(new Dictionary<string, string>
                {
                    ...
                    [LocalizationKeys.NavigationSectionName("expenses")] = "Expenses",
                    ...
                    [LocalizationKeys.ModuleName("reports")] = "Statistics",
                    [LocalizationKeys.ModuleName("statistics")] = "Statistics",
                    [LocalizationKeys.ModuleName("billing")] = "Billing",
                    [LocalizationKeys.ModuleName("expenses")] = "Expenses",
                    [LocalizationKeys.ModuleName("suppliers")] = "Suppliers",
                    [LocalizationKeys.ModuleName("settings")] = "Settings",
                    [LocalizationKeys.ModuleName("cash_registers")] = "Cash Registers",
                    [LocalizationKeys.ModuleName("digital_menu")] = "Digital menu",
                    [LocalizationKeys.ModuleName("printing")] = "Printing",
                    [LocalizationKeys.NavigationOptionName("tables.manage")] = "Manage tables",
                    [LocalizationKeys.NavigationOptionName("cash-registers.manage")] = "Manage cash registers",
                    [LocalizationKeys.NavigationOptionName("digital-menu.manage")] = "Manage menu",
                    ...
                    [LocalizationKeys.ProductInUse] = "The product is part of a combo. Remove it from the combo before disabling, converting, or deleting it.",
                    ...
                    [LocalizationKeys.CashRegisterNotFound] = "The requested cash register was not found.",
                    [LocalizationKeys.CashRegisterNameAlreadyExists] = "A cash register with that name already exists in the organization.",
                    [LocalizationKeys.CashRegisterSingleActiveExceeded] = "An active cash register already exists in this organization. Disable it before activating another one.",
                    [LocalizationKeys.CashRegisterInUse] = "The cash register has registered operations and cannot be deleted.",
                    [LocalizationKeys.PrintingLocationNotFound] = "The requested printing location was not found.",
                    [LocalizationKeys.PrintAgentNotFound] = "The requested print agent was not found.",
                    [LocalizationKeys.PrintAgentPairingInvalid] = "The pairing code is invalid or expired.",
                    [LocalizationKeys.PrintAgentCredentialInvalid] = "The print agent credential is invalid.",
                    [LocalizationKeys.PrinterNotFound] = "The requested printer was not found.",
                    [LocalizationKeys.PrintingZoneNotFound] = "The requested printing zone was not found.",
                    [LocalizationKeys.PrintingZoneAlreadyExists] = "A printing zone with that name already exists at the location.",
                    [LocalizationKeys.PrintJobNotFound] = "The requested print job was not found.",
                    [LocalizationKeys.PrintJobInvalidStatus] = "The print job is not in a valid state for this action.",
