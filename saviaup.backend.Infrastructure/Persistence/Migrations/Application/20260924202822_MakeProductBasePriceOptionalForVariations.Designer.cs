...
namespace SaviaUp.Backend.Infrastructure.Persistence.Migrations.Application
{
    ...
    [Migration("20260924202822_MakeProductBasePriceOptionalForVariations")]
    partial class MakeProductBasePriceOptionalForVariations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.CategoryPrintingRoute", b =>
                {
                    ...
                    b.HasKey("PrintingZoneId", "CategoryId");

                    b.HasIndex("CategoryId");

                    b.HasIndex("TenantId", "CategoryId");

                    b.ToTable("category_printing_routes", (string)null);
                });

            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.DigitalMenuItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "ItemType", "SortOrder");

                    b.ToTable("digital_menu_items", null, t =>
                        {
                            t.HasCheckConstraint("CK_digital_menu_items_ItemType", "\"ItemType\" IN ('CATEGORY', 'PRODUCT')");
                        });
                });
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.Expense", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("AnnulledAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.OrderItemComboSelection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("SelectionQuantity")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("order_item_combo_selections", null, t =>
                        {
                            t.HasCheckConstraint("CK_order_item_combo_selections_Quantities", "\"ProductQuantity\" >= 1 AND \"SelectionQuantity\" >= 1");
                        });
                });
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.PrintAgent", b =>
                {
                    ...
                    b.HasIndex("TenantId", "Enabled", "LastSeenAt");

                    b.ToTable("print_agents", (string)null);
                });

            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.PrintAgentCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "PrintAgentId", "ExpiresAt");
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.PrintAgentDiscovery", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("LastCredentialIssuedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("NetworkFingerprint")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
                    ...
                    b.HasIndex("DeviceIdentifier", "ExpiresAt");

                    b.HasIndex("NetworkFingerprint", "Status", "ExpiresAt");

                    b.ToTable("print_agent_discoveries", null, t =>
                        {
                            t.HasCheckConstraint("CK_print_agent_discoveries_Status", "\"Status\" IN ('PENDING', 'AUTHORIZED', 'CONSUMED')");
                        });
                });
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.PrintAgentPairingCode", b =>
                {
                    ...
                    b.HasIndex("TenantId", "ExpiresAt", "ConsumedAt");

                    b.ToTable("print_agent_pairing_codes", (string)null);
                });

            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.PrintJob", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTimeOffset?>("ReprintRequestedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("ReprintRequestedByUserId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OriginalPrintJobId");

                    b.HasIndex("PrintAgentId");

                    b.HasIndex("PrinterId");

                    b.HasIndex("PrintingZoneId");

                    b.HasIndex("TenantId", "PrintAgentId", "Status");
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.Printer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("LocalPrinterName")
                        .HasMaxLength(260)
                        .HasColumnType("character varying(260)");
                    ...
                    b.HasIndex("TenantId", "PrintAgentId", "Name")
                        .IsUnique();

                    b.ToTable("printers", null, t =>
                        {
                            t.HasCheckConstraint("CK_printers_PaperWidth", "\"PaperWidth\" IN (58, 80)");

                            t.HasCheckConstraint("CK_printers_Port", "\"Port\" IS NULL OR (\"Port\" BETWEEN 1 AND 65535)");
                        });
                });

            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.PrintingZone", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "LocationId", "NormalizedName")
                        .IsUnique();

                    b.ToTable("printing_zones", (string)null);
                });

            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.PrintingZonePrinter", b =>
                {
                    b.Property<Guid>("PrintingZoneId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("PrintingZoneId", "PrinterId");

                    b.HasIndex("PrinterId");

                    b.HasIndex("TenantId", "PrintingZoneId");

                    b.ToTable("printing_zone_printers", (string)null);
                });
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.ProductComboGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "ComboProductId", "Order");

                    b.ToTable("product_combo_groups", null, t =>
                        {
                            t.HasCheckConstraint("CK_product_combo_groups_Limits", "\"MinSelections\" >= 0 AND \"MaxSelections\" >= 1 AND \"MinSelections\" <= \"MaxSelections\"");

                            t.HasCheckConstraint("CK_product_combo_groups_SelectionType", "\"SelectionType\" IN ('SINGLE', 'MULTIPLE', 'FIXED')");
                        });
                });

            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.ProductComboOption", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ComboGroupId", "ProductId")
                        .IsUnique()
                        .HasFilter("\"ProductVariationId\" IS NULL");

                    b.HasIndex("ComboGroupId", "ProductVariationId")
                        .IsUnique()
                        .HasFilter("\"ProductVariationId\" IS NOT NULL");

                    b.HasIndex("TenantId", "ComboGroupId", "Order");

                    b.ToTable("product_combo_options", null, t =>
                        {
                            t.HasCheckConstraint("CK_product_combo_options_ProductQuantity", "\"ProductQuantity\" >= 1");
                        });
                });

            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.ProductPrintingRoute", b =>
                {
                    b.Property<Guid>("PrintingZoneId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("PrintingZoneId", "ProductId");

                    b.HasIndex("ProductId");

                    b.HasIndex("TenantId", "ProductId");

                    b.ToTable("product_printing_routes", (string)null);
                });
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.ProductRecipeItem", b =>
                {
                    ...
                    b.ToTable("product_recipe_items", null, t =>
                        {
                            t.HasCheckConstraint("CK_product_recipe_items_Quantity_Positive", "\"Quantity\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.Supplier", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.CategoryPrintingRoute", b =>
                {
                    ...
                    b.Navigation("PrintingZone");
                });

            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.Expense", b =>
                {
                    b.HasOne("SaviaUp.Backend.Domain.Entities.Supplier", "Supplier")
                        .WithMany()
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.OrderItemComboSelection", b =>
                {
                    b.HasOne("SaviaUp.Backend.Domain.Entities.ProductComboGroup", "ComboGroup")
                        .WithMany()
                        .HasForeignKey("ComboGroupId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("SaviaUp.Backend.Domain.Entities.ProductComboOption", "ComboOption")
                        .WithMany()
                        .HasForeignKey("ComboOptionId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("SaviaUp.Backend.Domain.Entities.OrderItem", "OrderItem")
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.PrintJob", b =>
                {
                    ...
                    b.HasOne("SaviaUp.Backend.Domain.Entities.PrintJob", "OriginalPrintJob")
                        .WithMany()
                        .HasForeignKey("OriginalPrintJobId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("SaviaUp.Backend.Domain.Entities.Printer", "Printer")
                        .WithMany()
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.ProductComboGroup", b =>
                {
                    b.HasOne("SaviaUp.Backend.Domain.Entities.Product", "ComboProduct")
                        .WithMany("ComboGroups")
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.ProductComboOption", b =>
                {
                    ...
                    b.HasOne("SaviaUp.Backend.Domain.Entities.ProductVariation", "ProductVariation")
                        .WithMany()
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.Printer", b =>
                {
                    b.Navigation("ZoneLinks");
                });

            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.PrintingZone", b =>
                {
                    b.Navigation("CategoryRoutes");
