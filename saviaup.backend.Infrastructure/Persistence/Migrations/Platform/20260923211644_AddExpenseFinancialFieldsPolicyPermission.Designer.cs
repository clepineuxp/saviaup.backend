...
namespace SaviaUp.Backend.Infrastructure.Persistence.Migrations.Platform
{
    ...
    [Migration("20260923211644_AddExpenseFinancialFieldsPolicyPermission")]
    partial class AddExpenseFinancialFieldsPolicyPermission
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SaviaUp.Backend.Domain.Entities.Permission", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Code = "expenses.read",
                            Description = "expenses.read",
                            ModuleId = new Guid("10000000-0000-0000-0000-000000000011")
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Code = "digital-menu.enable",
                            Description = "digital-menu.enable",
                            ModuleId = new Guid("10000000-0000-0000-0000-000000000013")
                        },
                        new
                        {
                            Id = new Guid("20000000-0000-0000-0000-000000000047"),
                            Code = "digital-menu.style.manage",
                            Description = "digital-menu.style.manage",
                            ModuleId = new Guid("10000000-0000-0000-0000-000000000013")
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Code = "settings.expense-financial-fields.manage",
                            Description = "settings.expense-financial-fields.manage",
                            ModuleId = new Guid("10000000-0000-0000-0000-000000000008")
                        });
                });
